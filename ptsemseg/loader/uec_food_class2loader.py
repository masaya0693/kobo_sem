...
class uec_food_class2Loader(data.Dataset):
    ...
    def __init__(
        ...
        path = pjoin(self.root, "uec_food/uecfood100_seg/ImageSets/", split + ".txt")
...
#         self.setup_annotations()
    ...
    def __getitem__(self, index):
        ...
        im_path = pjoin(self.root, "uec_food/uecfood100_seg/training", im_name + ".jpg")
        lbl_path = pjoin(self.root, "uec_food/uecfood100_seg/Masks", im_name + ".png")
